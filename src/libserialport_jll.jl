...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import libserialport_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("220460dc-b50e-5ed0-8176-09b0fd261e90"))
platforms = [Pkg.Artifacts.unpack_platform(e, "libserialport", artifacts_toml) for e in artifacts["libserialport"]]
...
if best_platform === nothing
    @debug("Unable to load libserialport; unsupported platform $(triplet(platform_key_abi()))")
else
